...
The random field modeling follows the statistical approach of mutual information nalysis by Shannon, and can be viewed as a continuous extension of the traditional analysis based on random vectors. 
