...
\blue{\textbf{Authors: } 
Many thanks for pointing out these limitations in {\bf Section VI-D} of this paper. As mentioned by the reviewer, the ``capacity'' should have an operational meaning, and the maximum mutual information does not necessarily equal the ``capacity''. This is absolutely true in general. 
