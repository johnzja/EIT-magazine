...
\blue{
    ...
    \quad As is pointed out by the reviewer, the figure (Fig.~\ref{fig:LTI_LSI_new_deprecated} in this response, which corresponds to Fig.~2 in the magazine paper) is somewhat confusing, since 

    \begin{figure}[h]
        \centering 
        \includegraphics[width=0.8\linewidth]{../figures/LTI-LSI-new.pdf} 
        ...
        \label{fig:LTI_LSI_new_deprecated}
    \end{figure}
